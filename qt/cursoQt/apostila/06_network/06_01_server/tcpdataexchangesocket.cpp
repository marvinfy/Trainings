...
void TcpDataExchangeSocket::readClient()
{
	...
	requestArgument = bytes.data() ; // converte para QString
*/
	...
	QDataStream out ( this ); // (ou 'QTextStream': analise o caso de uso...)
	out.setVersion(QDataStream::Qt_4_6);

	out << reply ;  // QDataStream suporta uma variedade de tipos... ver sua documentação
