...
int main(int argc, char *argv[])
{
    QApplication a(argc, argv);
	 ...
	 QPushButton * buttonMain = new QPushButton("Button Main", 0);
																																	// sem parent
	...
	// quitButton->setParent(&labelMain2);
	 QPushButton * aboutButton =
																	new QPushButton("Sobre Qt", &labelMain2);
...
*/
	 ...
	 gridLay->addItem(new QSpacerItem(10,10, QSizePolicy::Expanding,
												 QSizePolicy::Fixed),	0, 0); // linha zero, coluna zero
	 ...
	 gridLay->addItem(new QSpacerItem(10,10, QSizePolicy::Expanding,
												 QSizePolicy::Fixed),	1, 0); // linha 1 coluna 0
	 gridLay->addWidget(quitButton, 1, 1, 1,1, Qt::AlignHCenter );
																		// linha 1, coluna 1
	 gridLay->addItem(new QSpacerItem(10,10, QSizePolicy::Expanding,
												 QSizePolicy::Fixed),  1, 2); // linha 1, coluna 2
	 
	 gridLay->addItem(new QSpacerItem(10,10, QSizePolicy::Fixed,
	...
	// não precisaria disso se tivesse alocado "buttonMain" na pilha.
	 ...
	 return ret; // aqui são chamadas as destrutoras
	 // para labelMain1 e labelMain2
	 // NÃO PRECISO  deletar quitButton e aboutButton,
		//pois isso será feito pela destrutora de seu parent labelMain2

	// os layouts também serão deletados porque são filhos
	 // de seus widgets.
}
